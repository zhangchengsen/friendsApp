	...
	<view>
			...
			<view class="uni-btn-v  uni-common-mt">
				...
				<view class="flex justify-center align-center p-2">
					...
					<view  v-for="(value,key) in providerList" @click="tologin(value)"  class="iconfont   flex align-center justify-center    rounded-circle font-lg text-white" style="width: 100rpx;height: 100rpx;margin: 15rpx;" :class="value.icon +' '+ value.bgColor" >
					</view>
